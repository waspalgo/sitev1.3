  ...
  return (
    <GlassCard glow className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-text-primary mb-2">XAUUSD – Or</h2>
          <p className="text-text-muted text-sm">Prix actuel</p>
        </div>
        <div className="text-right">
          <p className="text-3xl font-bold text-text-primary">$2,045.32</p>
          <p className="text-positive text-sm font-semibold">+0.85%</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        <div>
          ...
          <p className="text-text-primary font-semibold">$2,052.10</p>
        </div>
        <div>
          <p className="text-text-muted text-xs mb-1">24h Low</p>
          <p className="text-text-primary font-semibold">$2,038.45</p>
        </div>
        <div>
          <p className="text-text-muted text-xs mb-1">Volume</p>
          <p className="text-text-primary font-semibold">1.2M</p>
        </div>
      </div>
    </GlassCard>
  );
